...
public class Feedback {
    ...
    @NotNull
    private String nextWeekAvailability;
    
    @Column(name = "nextWeekSuggestions")
    private String nextWeekSuggestions;
     ...
     */
    public Feedback(String weeklyFeedback, String nextWeekAvailability, String nextWeekSuggestions) {
